function [AnalogSignals,ALabels,AnalogFrameRate]=...
    readc3dEMGRemote(FullFileName, varargin)
...
AnalogSignalsFinal(1:size(AnalogSignals,1),1:8) = 0;
AnalogSignalsFinal(:,9:74)= AnalogSignals;
close(h) % waitbar
ALabels = {'Voltage.1','Voltage.2','Voltage.3','Voltage.4','Voltage.5','Voltage.6','Voltage.7','Voltage.8','Voltage.1','AccX1','AccY1','AccZ1','Voltage.2','AccX2','AccY2','AccZ2','Voltage.3','AccX3','AccY3','AccZ3',...
    'Voltage.4','AccX4','AccY4','AccZ4','Voltage.5','AccX5','AccY5','AccZ5','Voltage.6','AccX6','AccY6','AccZ6',...
    'Voltage.7','AccX7','AccY7','AccZ7','Voltage.8','AccX8','AccY8','AccZ8','Voltage.9','AccX9','AccY9','AccZ9',...
    'Voltage.10','AccX10','AccY10','AccZ10','Voltage.11','AccX11','AccY11','AccZ11','Voltage.12','AccX12','AccY12','AccZ12',...
    'Voltage.13','AccX13','AccY13','AccZ13','Voltage.14','AccX14','AccY14','AccZ14','Voltage.15','AccX15','AccY15','AccZ15',...
    'Voltage.16','AccX16','AccY16','AccZ16'}; 
AnalogSignals = AnalogSignalsFinal;
fclose(fid);
