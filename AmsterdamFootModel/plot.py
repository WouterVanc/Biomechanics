...
def plot_AFM_R(Dynamic_data, forefootanalysis, normalize):
    ...
    save.jpeg(f1,'AFM_Kinematics','foot_right')
    save.jpeg(f2,'AFM_Kinematics','midfoot_right')
    save.jpeg(f3,'AFM_Kinematics','arches_right')
...
def plot_AFM_L(Dynamic_data, forefootanalysis, normalize):
    ...
    save.jpeg(f1,'AFM_Kinematics','foot_left')
    save.jpeg(f2,'AFM_Kinematics','midfoot_left')
    save.jpeg(f3,'AFM_Kinematics','arches_left')
