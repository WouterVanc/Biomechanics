...
loadvars_perpeak = fieldnames(loading_results.co.p1);
loadvars_imp = fieldnames(loading_results.co.imp);
loadvars_stance = fieldnames(loading_results.co.stance);
...
% Results directories
path_out = fullfile(cd,'Results_load_condyles_CO');
...
for q = 1:length(loadvars_perpeak_med)
    ...
    %%%%% Peak 1 %%%%%
    % mean and std
    mean_lat = mean(loading_results.co.p1.(loadvars_perpeak_lat{q}));
    std_lat = std(loading_results.co.p1.(loadvars_perpeak_lat{q}));
    mean_med = mean(loading_results.co.p1.(loadvars_perpeak_med{q}));
    std_med = std(loading_results.co.p1.(loadvars_perpeak_med{q}));
    ...
    [p,h] = signrank(loading_results.co.p1.(loadvars_perpeak_med{q}), loading_results.co.p1.(loadvars_perpeak_lat{q}));
    pval_matrix_p1(q,5) = p;

    % Boxplot figure
    y(:,1) = loading_results.co.p1.(loadvars_perpeak_med{q})/factor;
    y_temp = loading_results.co.p1.(loadvars_perpeak_lat{q})/factor;
    y(:,2) = y_temp;
    ...
    %%%%% Peak 2 %%%%%
    % mean and std
    mean_lat = mean(loading_results.co.p2.(loadvars_perpeak_lat{q}));
    std_lat = std(loading_results.co.p2.(loadvars_perpeak_lat{q}));
    mean_med = mean(loading_results.co.p2.(loadvars_perpeak_med{q}));
    std_med = std(loading_results.co.p2.(loadvars_perpeak_med{q}));
    ...
    [p2,h2] = signrank(loading_results.co.p2.(loadvars_perpeak_med{q}), loading_results.co.p2.(loadvars_perpeak_lat{q}));
    pval_matrix_p2(q,5) = p2;

    % Boxplot figure
    y(:,1) = loading_results.co.p2.(loadvars_perpeak_med{q})/factor;
    y_temp = loading_results.co.p2.(loadvars_perpeak_lat{q})/factor;
    y(:,2) = y_temp;
...
for q = 1:length(loadvars_imp_lat)
    ...
    mean_lat = mean(loading_results.co.imp.(loadvars_imp_lat{q}));
    std_lat = std(loading_results.co.imp.(loadvars_imp_lat{q}));
    mean_med = mean(loading_results.co.imp.(loadvars_imp_med{q}));
    std_med = std(loading_results.co.imp.(loadvars_imp_med{q}));
    ...
    [p3,h] = ranksum(loading_results.co.imp.(loadvars_imp_lat{q}),loading_results.co.imp.(loadvars_imp_med{q}));

    pval_matrix_imp(q,5) = p3;
                                                                                    
    % Boxplot figure
    y(:,1) = loading_results.co.imp.(loadvars_imp_med{q});
    y_temp = loading_results.co.imp.(loadvars_imp_lat{q});
    y(:,2) = y_temp;
...
for q = 1
    suffix = '[MPa]';
    factor = 1000000;
    mean_oa = mean(loading_results.co.stance.(loadvars_stance_lat));
    std_oa = std(loading_results.co.stance.(loadvars_stance_lat));
    mean_co = mean(loading_results.co.stance.(loadvars_stance_med));
    std_co = std(loading_results.co.stance.(loadvars_stance_med));
    ...
    [p4,h] = ranksum(loading_results.co.stance.(loadvars_stance_lat),loading_results.co.stance.(loadvars_stance_med));
    pval_matrix_stance(q,5) = p4;

    % Boxplot figure
    y(:,1) = loading_results.co.stance.(loadvars_stance_med)/1000000;
    y_temp = loading_results.co.stance.(loadvars_stance_lat)/1000000;
    y(:,2) = y_temp;
...
% Write to Excel file
filename = 'Loadvars_condyles_CO.xlsx';
